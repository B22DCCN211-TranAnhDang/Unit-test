...
function SearchContent() {
  ...
  return (
    <Box>
      ...
      {/* No Results Message with Order Book Link */}
      {searchQuery && books.length === 0 && totalCount === 0 && (
        <Box mt={6} textAlign="center" py={8}>
          <Text fontSize="md" color="secondaryText.500" mb={4}>
